...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        tripId = intent.getStringExtra(AppUtils.LocationConstants.TRIP_ID);
        lat = intent.getDoubleExtra(AppUtils.LocationConstants.TRIP_LAT,1);
    ...
    private void deliverResultToReceiver(int resultCode, String message, Address address) {
        try {
            ...
            bundle.putString(AppUtils.LocationConstants.TRIP_ID, tripId);
            bundle.putDouble(AppUtils.LocationConstants.TRIP_LAT, lat);
